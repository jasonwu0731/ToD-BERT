...
parser.add_argument("-epoch", "--epoch", help="number of epochs to train", required=False, default=300, type=int)
parser.add_argument(
...
parser.add_argument("-lr", "--learning_rate", help="Learning Rate", required=False, type=float, default=5e-5)
parser.add_argument("-bsz", "--batch_size", help="Batch_size", required=False, type=int, default=16)
parser.add_argument("-ebsz", "--eval_batch_size", help="Batch_size", required=False, type=int, default=16)
...
parser.add_argument("-clip", "--grad_clip", help="gradient clipping", required=False, default=1, type=int)
parser.add_argument(
...
parser.add_argument("-task_name", "--task_name", help='task in ["intent", "sysact","rs"]', required=False, default="")
...
parser.add_argument("-load_path", "--load_path", help="path of the saved model to load from", required=False)
parser.add_argument("-an", "--add_name", help="An added name for the save folder", required=False, default="")
parser.add_argument(
    "--max_line", help="maximum line for reading data (for quick testing)", required=False, default=None, type=int
)
parser.add_argument("--output_dir", help="", required=False, default="save/temp/", type=str)
...
parser.add_argument("-um", "--unk_mask", help="mask out input token to UNK", type=bool, required=False, default=True)
...
parser.add_argument("--rnn_type", help='rnn type ["gru", "lstm"]', required=False, type=str, default="gru")
...
parser.add_argument("--ontology_version", default="", type=str, help="1.0 is the cleaned version but not used")
parser.add_argument(
    "--dstlm",
    action="store_true",
    help="",
